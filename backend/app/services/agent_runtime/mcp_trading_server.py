...
MCP_TOOL_CATALOG: dict[str, dict[str, Any]] = {
    "market_snapshot": {
        ...
        "description": "Snapshot marché normalisé avec métriques dérivées (spread ratio, candle ratios).",
        "section": "market_data",
        "enabled_by_default": True,
    },
    "indicator_bundle": {
        "label": "Indicator Bundle",
        "description": "Calcul réel RSI, EMA, MACD, ATR depuis données OHLC brutes — pas de passthrough.",
        "section": "technical",
        "enabled_by_default": True,
    },
    "divergence_detector": {
        "label": "Divergence Detector",
        "description": "Détection divergences RSI-prix haussières/baissières sur N barres.",
        "section": "technical",
        "enabled_by_default": True,
    },
    "support_resistance_detector": {
        "label": "Support/Resistance Detector",
        "description": "Identification niveaux S/R par clustering de pivots avec comptage de touches.",
        "section": "technical",
        "enabled_by_default": True,
    },
    "pattern_detector": {
        "label": "Pattern Detector",
        "description": "Détection patterns chandeliers : doji, hammer, engulfing, pin bar, shooting star.",
        "section": "technical",
        "enabled_by_default": True,
    },
    "multi_timeframe_context": {
        "label": "Multi-Timeframe Context",
        "description": "Synthèse alignement multi-TF avec score de confluence et direction dominante.",
        "section": "context",
        "enabled_by_default": True,
    },
    "market_regime_detector": {
        "label": "Market Regime Detector",
        "description": "Classification régime marché (trending/ranging/volatile/calm) par slope + ATR.",
        "section": "context",
        "enabled_by_default": True,
    },
    "session_context": {
        "label": "Session Context",
        "description": "Sessions marché actives, overlaps et conditions de liquidité en temps réel.",
        "section": "context",
        "enabled_by_default": True,
    },
    "correlation_analyzer": {
        "label": "Correlation Analyzer",
        "description": "Corrélation Pearson rolling entre deux séries de prix avec analyse lead/lag.",
        "section": "context",
        "enabled_by_default": True,
    },
    "volatility_analyzer": {
        "label": "Volatility Analyzer",
        "description": "ATR, volatilité historique, Bollinger bandwidth, percentile de volatilité.",
        "section": "context",
        "enabled_by_default": True,
    },
    "news_search": {
        "label": "News Search",
        "description": "Normalisation, déduplication et scoring de pertinence des news par symbole.",
        "section": "news",
        "enabled_by_default": True,
    },
    "macro_event_feed": {
        "label": "Macro Event Feed",
        "description": "Filtrage et scoring d'impact des événements macro-économiques.",
        "section": "news",
        "enabled_by_default": True,
    },
    "sentiment_parser": {
        "label": "Sentiment Parser",
        "description": "Parsing directionnel sentiment depuis headlines avec dictionnaires par classe d'actif.",
        "section": "news",
        "enabled_by_default": True,
    },
    "symbol_relevance_filter": {
        "label": "Symbol Relevance Filter",
        "description": "Filtre news et macro par seuil de pertinence pour un symbole donné.",
        "section": "news",
        "enabled_by_default": True,
    },
    "evidence_query": {
        "label": "Evidence Query",
        "description": "Agrégation et scoring des évidences issues des agents avec consensus directionnel.",
        "section": "debate",
        "enabled_by_default": True,
    },
    "thesis_support_extractor": {
        "label": "Thesis Support Extractor",
        "description": "Normalisation et pondération des arguments de thèse pour agents de débat.",
        "section": "debate",
        "enabled_by_default": True,
    },
    "scenario_validation": {
        "label": "Scenario Validation",
        "description": "Validation scénario trading avec géométrie SL/TP et ratio risk/reward.",
        "section": "risk",
        "enabled_by_default": True,
    },
    "position_size_calculator": {
        "label": "Position Size Calculator",
        "description": "Calcul taille position adapté par classe d'actif avec vérification marge.",
        "section": "risk",
        "enabled_by_default": True,
    },
    "memory_query": {
        "label": "Memory Query",
        "description": "Accès mémoire agentique : recherche, feedback, statistiques par agent.",
        "section": "memory",
        "enabled_by_default": True,
    },
}
