...
AGENT_PROMPTS: dict[str, dict[str, str]] = {
    ...
    "trader-agent": {
        ...
        "user": (
            ...
            "1. ALWAYS call decision_gating() with your combined_score, confidence, aligned_sources\n"
            "2. ALWAYS call contradiction_detector() — even if gates failed or you already decided HOLD\n"
