...
class Settings(BaseSettings):
    ...
    celery_optimizer_queue: str = Field(default='strategy-optimizer', alias='CELERY_OPTIMIZER_QUEUE')
    celery_optimizer_soft_time_limit_seconds: int = Field(default=420, alias='CELERY_OPTIMIZER_SOFT_TIME_LIMIT_SECONDS')
    celery_optimizer_time_limit_seconds: int = Field(default=480, alias='CELERY_OPTIMIZER_TIME_LIMIT_SECONDS')
    optimizer_max_iterations: int = Field(default=50, alias='OPTIMIZER_MAX_ITERATIONS')
    optimizer_max_iterations_limit: int = Field(default=200, alias='OPTIMIZER_MAX_ITERATIONS_LIMIT')
    optimizer_time_budget_seconds: int = Field(default=300, alias='OPTIMIZER_TIME_BUDGET_SECONDS')
    optimizer_time_budget_limit: int = Field(default=1800, alias='OPTIMIZER_TIME_BUDGET_LIMIT')
    optimizer_max_candidates_per_iteration: int = Field(default=3, alias='OPTIMIZER_MAX_CANDIDATES_PER_ITERATION')
